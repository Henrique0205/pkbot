...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5589994524151 \n (89) 994524151\n' // wa.me/558994524151 + 89994524151
            + 'END:VCARD'
/******END OF VCARD INPUT******/
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário!(henrique😌) ❌',
					ownerB: '[❗] Este comando só pode ser usado pelo henrique! ❌',
			...
			const ownerNumber = ["5589994524151@s.whatsapp.net"] // replace this with your number
